        ...
        <div class="col-lg-12 col-xs-12">         
          ...
          <div class="card card-info noprint">
            ...
            <div class="card-header">              
              <h3 class="card-title">Laporan B1 Polri & B2 PNS</h3>                                                    
            </div>
            <div class="card-body">    
              <form class="form-inline" id="formBulanTahun">
                ...
                <div class="form-group" style="padding-right: 15px;">
                  ...
                  <button type="submit" name="submitBulanTahun" class="btn btn-success" id="btnPilih" style="margin-right: 10px;"><i class="fa fa-eye"></i> Tampilkan</button>
                  <button class="btn btn-default" onClick="printReport()" style="margin-right: 10px;"><i class="fa fa-print"></i> Print</button>
                </div>
              </form>
              </div>
            </div>
