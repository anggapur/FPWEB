        ...
        <div class="col-lg-12 col-xs-12">         
          ...
          <div class="card card-info noprint" >
            ...
            <div class="card-header">              
              <h3 class="card-title">Laporan C1 Polri & C2 PNS</h3>                            
            </div>
            <div class="card-body">    
              <form class="form-inline" id="formBulanTahun">
                <div class="form-group" style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Bulan</label>
                  <select class="form-control" name="bulan">
                    {!!CH::printBulan()!!}
                  </select>
                </div>
                <div class="form-group" style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Tahun</label>
                ...
                <div class="form-group @if(Auth::user()->level != 'admin') hide @endif" style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Kode Satker</label>
                ...
                <div class="form-group" style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Kode Anak Satker</label>
                ...
                @else
                <div class="form-group" id="anakSatkerAdmin" style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Kode Anak Satker</label>
                ...
                @endif            
                <div class="form-group " style="padding-right: 15px;">
                  <label style="padding-right: 10px;">Kategori</label>
                  <select class="js-example-basic-single form-control" name="jenis_pegawai">    
                    {!!CH::printOptionJenisPegawai()!!}              
                  </select>                 
                </div>  
                <div class="form-group" style="padding:10px 0px;">
                  <button style="margin-right: 10px;" type="submit" class="btn btn-success" id="btnPilih" name="submitBulanTahun"><i class="fa fa-eye"></i> Tampilkan</button>
                  <button style="margin-right: 10px;" type="button" class="btn btn-default" onClick="printReport()"><i class="fa fa-print"></i> Print</button>
                  <button style="margin-right: 10px;" type="button" class="btn btn-primary" onClick="exportDataBank()"><i class="fa fa-download"></i> Export Data Untuk Bank</button>
                </div>
              </form>
              </div>
            </div>
