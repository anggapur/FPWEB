        ...
        <div class="col-lg-12 col-xs-12">         
          ...
          <div class="card card-info noprint">
            ...
            <div class="card-header">              
              <h3 class="card-title">Form Surat Pernyataan Tanggung Jawab Mutlak</h3>                            
            </div>
            <div class="card-body">    
              <form class="form-inline" id="formBulanTahun">
                ...
                <div class="form-group @if(Auth::user()->level != 'admin') hide @endif" style="padding-right: 10px;">
                ...
                <div class="form-group" style="padding-right: 10px;">
                  <button style="margin-right: 10px;" type="submit" name="submitBulanTahun" class="btn btn-success" id="btnPilih"><i class="fa fa-eye"></i> Tampilan</button>
                  <button style="margin-right: 10px;" class="btn btn-default" onClick="printReport()"><i class="fa fa-print"></i> Print</button>
                </div>
              </form>
              </div>
            </div>
